function carregar_descricoes() {
  ...
  proj_textos[2] = "Escaneamento 3D do objeto e interação com o modelo.";
  ...
  proj_textos[3] = "Aplicativo que utiliza métodos de C.V. para extrair pixels estáticos.";
  ...
  video_links[6] = '<iframe width="640" height="360" src="https://www.youtube.com/embed/aX4rA1TgBpI?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0"gesture="media" allowfullscreen></iframe>';
    ...
    proj_textos[7] = "Interface que responde à presença do usúario utilizando Face Tracking.";
    ...
    proj_textos[14] = "Software para identificação de cortes na montagem de vídeos.";
    video_links[14] = '';
  ...
  proj_textos[18] = "Instalação para medição de dados da corrida do usúario e experiência de R.A.";
  video_links[18] = '';
}